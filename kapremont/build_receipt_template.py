...
hint = data.cell(4, 1,
                 ...
                 "Столбцы F, J и L можно оставить пустыми — бланк рассчитает "
...
PERIOD_DATE = (f'IF({lookup("$N")}="",{CFG_REF["Дата начала периода"]},'
               f'{d("$N")})')
DUE_DATE = (f'IF({lookup("$O")}="",{CFG_REF["Срок оплаты"]},{d("$O")})')
...
ws.row_dimensions[36].height = 17
put(ws, "B36:F36", f'="Срок оплаты: до "&{ru_date(DUE_DATE)}&" г."',
