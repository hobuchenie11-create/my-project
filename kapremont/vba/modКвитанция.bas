...
' Проставить период, срок оплаты и номер квитанции.
Public Sub ПодставитьПериод(ByVal ЛицевойСчет As Variant, _
                            ...
                            Optional ByVal СрокОплаты As Variant, _
                            Optional ByVal НомерКвитанции As Variant)
    Dim ws As Worksheet, стр As Long
    ...
    ЗаписатьЕслиЗадано ws, стр, К_НОМЕР, НомерКвитанции
End Sub
